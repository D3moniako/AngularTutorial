...
import { MyOrdersComponent } from './Componenti/my-orders/my-orders.component';
...
import { PaymentSuccessComponent } from './Componenti/payment-success/payment-success.component';
...
import { DashboardComponent } from './Componenti/admin/dashboard/dashboard.component';

import { AdminPlannersComponent } from './Componenti/admin/admin-planners/admin-planners.component';

import { AdminOrdersComponent } from './Componenti/admin/admin-orders/admin-orders.component';

import { AdminPaymentsComponent } from './Componenti/admin/admin-payments/admin-payments.component';

import { AdminUsersComponent } from './Componenti/admin/admin-users/admin-users.component';

import { AdminUploadComponent } from './Componenti/admin-upload-planner/admin-upload-planner.component';
