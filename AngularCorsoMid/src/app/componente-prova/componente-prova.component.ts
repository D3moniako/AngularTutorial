...
{
  // implementa anche Interfaccia OnInit che è la prima cosa che viene avviata
  ...
  cani: any = [
    // array di any quindi ci posso mettere tutto, non devo mettere il tipo all'interno ma solo chiave valore
    {
      nome: 'Rocky', //
      razza: 'bastardino',
      eta: 4,
  ...
  testo: string =
    'ciaoooooo dal ts commponent, questa è una string interpolation, posso richiamare qualsiasi cosa che ritorna stringa, quindi stringhe stessi  o metodi che ritornano stringhe';
  ...
  immagine1: string =
    'https://static.ohga.it/wp-content/uploads/sites/24/2021/08/iStock-933914464.jpg';
  immagine2: string =
    'https://www.tuttogreen.it/wp-content/uploads/2021/01/shutterstock_547175674.jpg';

  ngOnInit(): void {
    // dell'interfaccia OnInit  crea un metodo ngOnInit essendo un interfaccia devo implementare tutti i suoi metoidi,
    ...
    setInterval(
      () => {
        if (counter % 2 == 0 && counter <= 10) {
          ...
          this.immagine = this.immagine2;
          console.log(
            counter + " e' maggiore di 15 =>immagine di default leone",
          );
        }
